...
export class TrackSample {
	...
	initializeEventListeners() {
		...
		this.element.querySelector(".track_object_drag_handle").addEventListener("mousedown", (e) => {
			e.preventDefault();
			oldX = (<MouseEvent> e).clientX;
			initial_grab_offset = (<MouseEvent> e).clientX - cumulativeOffset(a).left;
		...
		function right_resize_listener(e: MouseEvent) {
			e.preventDefault();
		...
		right_resize.addEventListener("mousedown", (e) => {
			e.preventDefault();
			mouse_down_position = (<MouseEvent> e).clientX;
